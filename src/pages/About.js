  ...
  return(
    <>
      ...
      <blockquote className="container blockquote about">
        ...
        <footer className="blockquote-footer"> created by <cite title="Source Title"><a title="GitHub" target="_blank" href="https://github.com/AntoHany">Anton Hany</a></cite></footer>
      </blockquote>
